    ...
    <div className="min-h-dvh flex flex-col bg-[#F5F8FC]">
          ...
          <div className="grid grid-cols-4 gap-3">
            {avatarOptions.map((avatar) => (
              <motion.button
                ...
                className={`w-full aspect-square rounded-2xl flex items-center justify-center text-3xl transition-all ${selectedAvatar === avatar
      ...
      <div className="p-4 bg-white border-t-2 border-[#D5E3F7]">
        <motion.button
          onClick={handleSave}
          disabled={isSaving}
          className={`w-full py-4 text-lg font-semibold rounded-2xl flex items-center justify-center gap-2 transition-all ${saved
